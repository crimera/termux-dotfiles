...
getToken = requests.get(
    "https://open.spotify.com/get_access_token", params=params
).json()
...
# Download
os.system(
    f'yt-dlp https://music.youtube.com/watch?v={videoId} -x --embed-thumbnail --embed-metadata -o "{music}/%(title)s.%(ext)s" --postprocessor-args "ffmpeg:-filter:v crop=in_h"'
)
